...
This file provides guidance to any AI coding agent (Claude Code, Codex, etc.) when working with code in this repository. It mirrors `CLAUDE.md` for tools that follow the AGENTS.md convention.
